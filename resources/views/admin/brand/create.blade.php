                ...
                <div class="col-lg-6">
                    <div class="hpanel">
                        ...
                        <div class="panel-body">
                            ...
                            <form class="form-horizontal" method="POST"  id="form" action="{{ route('brands.store') }}">
                                {{ csrf_field() }}
                                <div class="form-group"><label>{{trans('brand.name')}}</label> <input type="text" placeholder="{{trans('brand.name')}}" class="form-control" name="name"></div>
                                @if ($errors->has('name'))
